...
?>
		...
		<body>
			<div id="graph" style="display:inline-block; width:750px; height:450px"></div>
...
<?php
	...
	echo '<div id="table" style="display:inline-block">';
	
	echo '<table style="border-collapse: collapse; height:100px; width:250px; margin-left:0px; margin-bottom:25px">';
	echo '<thead>';
	...
	for($i=0; $i<sizeof($t_arr); $i++){
		echo '<tr>';
		if($i%2 == 0){
			echo '<td style="border: 1px solid black; background-color: #afe07d; padding:5px; font-size:12; font-family:Arial">';
			echo $t_arr[$i];
			echo '</td>';
			echo '<td style="border: 1px solid black; background-color: #afe07d; padding:5px; font-size:12; font-family:Arial">';
			echo $points[$i];
